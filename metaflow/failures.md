...
It is highly recommended that you use `retry` every time you run your flow on the [cloud](https://github.com/jasonge27/metaflow-docs/tree/7b4d06d61f9b0c95ee3699df4b7f2ef708bdda32/metaflow-on-aws/metaflow-on-aws.md). Instead of annotating every step with a retry decorator, you can also automatically add a retry decorator to all steps that do not have one as follows:
